...
col_insert = c( '#e8a735','#e8a735','#008dcb', '#008dcb' ,'#D55448','#B6452c','#002c54' ,'#002c54')
...
Skalierte_data <- read_excel("C:/Users/andie/Downloads/Biochemie Nucleosome/Skalierte data.xlsx")


matplot( Skalierte_data[2:9],type = "o",  ylab = "",  cex = 0,  lty = c(1),lwd=2, las = 1, x = Skalierte_data$count,  xlab = "Insert size Histogram",  bg = "20",col =  col_insert,xlim=c(37,401))
legend(255.15,0.026,pt.cex = 0 ,  pch= 1, c( "light low digest", "light low digest", "light high digest", "light high digest",    "dark low digest", "dark low digest", "dark high digest", "dark high digest"),box.lty = 0,box.col = 0, box.lwd = 3, cex = 1.1, lwd = 2.2, lty = c(1,1), col = col_insertLegende  , text.col = col_insertLegende , merge = TRUE)

# new data 

matplot( Skalierte_data[2:5],type = "o",  ylab = "",  cex = 0,  lty = c(1),lwd=2, las = 1, x = Skalierte_data$count,  xlab = "Insert size Histogram", xlim=c(37,401), bg = "20",col = col_insert)
legend(285.15,0.026,pt.cex = 0  ,pch= 1, c( "light low digest", "light low digest", "light high digest", "light high digest"),box.lty = 0,box.col = 0, box.lwd = 4, cex = 0.9, lwd = 2.5, lty = c(1,1), col = col_insertLegende[1:4]  , text.col = col_insertLegende[1:4] , merge = TRUE)


matplot( Skalierte_data[6:9],type = "o",  ylab = "",  cex = 0,  lty = c(1),lwd=2, las = 1, x = Skalierte_data$count,  xlab = "Insert size Histogram", xlim=c(37,401), bg = "20",col =  col_insert[5:9])
legend(285.15,0.0244,pt.cex = 0  ,pch= 1, c( "dark low digest", "dark low digest", "dark high digest", "dark high digest"),box.lty = 0,box.col = 0, box.lwd = 4, cex = 0.9, lwd = 2.5, lty = c(1,1), col = col_darkLegende  , text.col = col_darkLegende , merge = TRUE)
